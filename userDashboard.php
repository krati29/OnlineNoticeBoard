...
if(isset($_POST['update_profile'])){
  ...
  $query = "update users set fname='$_POST[fname]',lname='$_POST[lname]',email='$_POST[email]',password='$_POST[password]',semester=$_POST[semester] where email='$_SESSION[email]'";
