        ...
        <form action="" method="post">
          <div class="form-group">
              ...
              <select class="form-control" name="to_whom">
                ...
                <option>To Semester 1</option>
                <option>To Semester 2</option>
                <option>To Semester 3</option>
                <option>To Semester 4</option>
                <option>To Semester 5</option>
                <option>To Semester 6</option>
              </select>
          </div>
          <div class="form-group">
